defmodule Dredd.Validators.ConfirmationTest do
  ...
  # TODO: 2022-12-15 - Rebuild as a special validator that can run on Maps 
  ...
  describe "validate_confirmation/3" do
    ...
    #            data: ^data,
    #            error: [{^field, [{"does not match", validation: :confirmation}]}],
    #            valid?: false
    ...
    #   assert %Dredd.Dataset{
    #            data: ^data,
    #            error: [{^confirmation_field, [{"can't be blank", validation: :required}]}],
    #            valid?: false
    ...
    #   assert %Dredd.Dataset{
    #            data: ^data,
    #            error: [{^field, [{^message, validation: :confirmation}]}],
    #            valid?: false
